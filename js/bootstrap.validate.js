...
(function() {
  ...
  $forms.attr('novalidate', 'novalidate').on('submit', function(submitEvent) {
    var errors;
    errors = [];
  ...
  $('input, textarea', $forms).not('[type="radio"]').not('[type="checkbox"]').on('change', function(changeEvent) {
    return validateTextField($(this));
  });

  $('input, textarea', $forms).not('[type="radio"]').not('[type="checkbox"]').on('keyup', function(keyupEvent) {
    var $this, timeout;
    $this = $(this);
